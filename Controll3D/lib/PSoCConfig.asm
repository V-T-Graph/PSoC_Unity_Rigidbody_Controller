...
export LoadConfig_controll3d
export _LoadConfig_controll3d
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_controll3d
	lcall	LoadConfigTBL_controll3d_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration controll3d
;
;    Load configuration registers for controll3d.
...
;               CUR_PP
;
_LoadConfig_controll3d:
 LoadConfig_controll3d:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_controll3d_Bank0
    mov     X, <LoadConfigTBL_controll3d_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_controll3d_Bank1
    mov     X, <LoadConfigTBL_controll3d_Bank1
