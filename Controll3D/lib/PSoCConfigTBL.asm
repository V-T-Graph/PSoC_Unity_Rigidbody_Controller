...
export LoadConfigTBL_controll3d_Bank1
export LoadConfigTBL_controll3d_Bank0
export LoadConfigTBL_controll3d_Ordered
AREA lit(rom, rel)
LoadConfigTBL_controll3d_Bank0:
;  Instance name Counter8, User Module Counter8
;       Instance name Counter8, Block Name CNTR8(DBB11)
	db		37h, 00h		;Counter8_CONTROL_REG(DBB11CR0)
	db		35h, 00h		;Counter8_PERIOD_REG(DBB11DR1)
	db		36h, 00h		;Counter8_COMPARE_REG(DBB11DR2)
...
;       Instance name PGA_2, Block Name GAIN(ACB01)
	...
	db		76h, a1h		;PGA_2_GAIN_CR1(ACB01CR1)
...
;  Instance name TRIADC, User Module TRIADC
;       Instance name TRIADC, Block Name ADC1(ASC10)
	db		80h, 90h		;TRIADC_bfADC1cr0(ASC10CR0)
	db		81h, 00h		;TRIADC_bfADC1cr1(ASC10CR1)
	db		82h, 61h		;TRIADC_bfADC1cr2(ASC10CR2)
	db		83h, f0h		;TRIADC_bfADC1cr3(ASC10CR3)
;       Instance name TRIADC, Block Name ADC2(ASD11)
	db		84h, 90h		;TRIADC_bfADC2cr0(ASD11CR0)
	db		85h, 00h		;TRIADC_bfADC2cr1(ASD11CR1)
	db		86h, 60h		;TRIADC_bfADC2cr2(ASD11CR2)
	db		87h, f0h		;TRIADC_bfADC2cr3(ASD11CR3)
;       Instance name TRIADC, Block Name ADC3(ASC12)
	db		88h, 90h		;TRIADC_bfADC3cr0(ASC12CR0)
	db		89h, 00h		;TRIADC_bfADC3cr1(ASC12CR1)
	db		8ah, 60h		;TRIADC_bfADC3cr2(ASC12CR2)
	db		8bh, f0h		;TRIADC_bfADC3cr3(ASC12CR3)
;       Instance name TRIADC, Block Name CNT1(DBB00)
	db		23h, 00h		;TRIADC_bCounter1_CR0(DBB00CR0)
	db		21h, 00h		;TRIADC_bPeriod1(DBB00DR1)
	db		22h, 00h		;TRIADC_bCompare1(DBB00DR2)
;       Instance name TRIADC, Block Name CNT2(DCB03)
	db		2fh, 00h		;TRIADC_bCounter2_CR0(DCB03CR0)
	db		2dh, 00h		;TRIADC_bPeriod2(DCB03DR1)
	db		2eh, 00h		;TRIADC_bCompare2(DCB03DR2)
;       Instance name TRIADC, Block Name CNT3(DBB10)
	db		33h, 00h		;TRIADC_bCounter3_CR0(DBB10CR0)
	db		31h, 00h		;TRIADC_bPeriod3(DBB10DR1)
	db		32h, 00h		;TRIADC_bCompare3(DBB10DR2)
;       Instance name TRIADC, Block Name PWM16_LSB(DBB01)
	db		27h, 00h		;TRIADC_fPWM_LSB_CR0(DBB01CR0)
	db		25h, 00h		;TRIADC_bPWM_Period_LSB(DBB01DR1)
	db		26h, 00h		;TRIADC_bPWM_IntTime_LSB(DBB01DR2)
;       Instance name TRIADC, Block Name PWM16_MSB(DCB02)
	db		2bh, 00h		;TRIADC_fPWM_MSB_CR0(DCB02CR0)
	db		29h, 00h		;TRIADC_bPWM_Period_MSB(DCB02DR1)
	db		2ah, 00h		;TRIADC_bPWM_IntTime_MSB(DCB02DR2)
...
;  Global Register values Bank 0
	db		60h, 14h		; AnalogColumnInputSelect register (AMX_IN)
	...
	db		bdh, 20h		; Row_1_OutputDrive_0 register (RDI1SRO0)
	db		beh, 00h		; Row_1_OutputDrive_1 register (RDI1SRO1)
	db		ffh
LoadConfigTBL_controll3d_Bank1:
;  Instance name Counter8, User Module Counter8
;       Instance name Counter8, Block Name CNTR8(DBB11)
	db		34h, 21h		;Counter8_FUNC_REG(DBB11FN)
	db		35h, 14h		;Counter8_INPUT_REG(DBB11IN)
	db		36h, 20h		;Counter8_OUTPUT_REG(DBB11OU)
;  Instance name LCD, User Module LCD
;  Instance name PGA_1, User Module PGA
;       Instance name PGA_1, Block Name GAIN(ACB00)
;  Instance name PGA_2, User Module PGA
...
;       Instance name TRIADC, Block Name ADC3(ASC12)
;       Instance name TRIADC, Block Name CNT1(DBB00)
	db		20h, 21h		;TRIADC_fCounter1FN(DBB00FN)
	db		21h, 45h		;TRIADC_fCounter1SL(DBB00IN)
	db		22h, 40h		;TRIADC_fCounter1OS(DBB00OU)
;       Instance name TRIADC, Block Name CNT2(DCB03)
	db		2ch, 21h		;TRIADC_fCounter2FN(DCB03FN)
	db		2dh, 55h		;TRIADC_fCounter2SL(DCB03IN)
	db		2eh, 40h		;TRIADC_fCounter2OS(DCB03OU)
;       Instance name TRIADC, Block Name CNT3(DBB10)
	db		30h, 21h		;TRIADC_fCounter3FN(DBB10FN)
	db		31h, 65h		;TRIADC_fCounter3SL(DBB10IN)
	db		32h, 40h		;TRIADC_fCounter3OS(DBB10OU)
;       Instance name TRIADC, Block Name PWM16_LSB(DBB01)
	db		24h, 01h		;TRIADC_bfPWM_LSB_FN(DBB01FN)
	db		25h, 15h		;TRIADC_(DBB01IN)
	db		26h, 40h		;TRIADC_(DBB01OU)
;       Instance name TRIADC, Block Name PWM16_MSB(DCB02)
	db		28h, 21h		;TRIADC_bfPWM_MSB_FN(DCB02FN)
	db		29h, 35h		;TRIADC_(DCB02IN)
	db		2ah, 40h		;TRIADC_(DCB02OU)
;  Instance name UART, User Module UART
;       Instance name UART, Block Name RX(DCB13)
	db		3ch, 05h		;UART_RX_FUNC_REG   (DCB13FN)
	db		3dh, 18h		;UART_RX_INPUT_REG  (DCB13IN)
	db		3eh, 00h		;UART_RX_OUTPUT_REG (DCB13OU)
;       Instance name UART, Block Name TX(DCB12)
	db		38h, 0dh		;UART_TX_FUNC_REG   (DCB12FN)
	db		39h, 08h		;UART_TX_INPUT_REG  (DCB12IN)
...
;  Global Register values Bank 1
	...
	db		e1h, 20h		; OscillatorControl_1 register (OSC_CR1)
...
LoadConfigTBL_controll3d_Ordered:
;  Ordered Global Register values
	...
	M8C_SetBank0
	mov	reg[03h], dfh		; Port_0_DriveMode_2 register (PRT0DM2)
